...
import { ArrowRight, Leaf, BarChart3, Lock, Zap, Shield, Users, Sun, Moon } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-gray-900 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={toggle}
              className="px-3 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg transition-all flex items-center"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 mb-24">
        <div className="grid grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="border border-gray-200 rounded-xl p-8 text-center bg-white shadow-sm hover:shadow-md transition-all">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            return (
              <div key={idx} className="border border-gray-200 rounded-xl p-8 bg-white shadow-sm hover:shadow-md transition-all">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 mb-24">
        <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">Built on Modern Tech</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="border border-gray-200 rounded-lg p-6 text-center bg-white shadow-sm hover:shadow-md transition-all">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="border border-gray-200 rounded-2xl p-16 text-center bg-white shadow-sm">
          <h2 className="text-4xl font-bold mb-6 text-gray-900">Ready to Transform Your Supply Chain?</h2>
          <p className="text-lg mb-8 text-gray-600">Start managing your agricultural supply chain with intelligence and transparency.</p>
          {!user && (
            <button
              onClick={() => navigate('/login')}
      ...
      <footer className="border-t border-gray-200 mt-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 py-12 text-center">
          <p className="text-gray-600">© 2026 AgriChain. Built with precision for agricultural excellence.</p>
        </div>
      </footer>
    </div>
  )
