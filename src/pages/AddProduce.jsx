    ...
    <MainLayout breadcrumb={['Inventory', 'Add Produce']}>
      <div className="max-w-2xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Register Produce</h1>
          <p className="text-sm sm:text-base mt-1 sm:mt-2 text-gray-600">Create a new batch and add it to your inventory</p>
        </div>
